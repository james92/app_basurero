...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { identifier: @table.identifier, location: @table.location, state: @table.state }
    end
  ...
  test "should update table" do
    put :update, id: @table, table: { identifier: @table.identifier, location: @table.location, state: @table.state }
    assert_redirected_to table_path(assigns(:table))
  end
